...
export const projectData = [
    {
      ...
      description: "An initiative aimed at exposing the reality of the ongoing genocide and fostering support for Palestine.",
    ...
    {
      title: "Memoirify",
      description: "Meet Memoirify. Your Magical Markdown Editor.",
    ...
    {
      title: "CMPDocs",
      description: "A guide for prospective and current students in the computer engineering department of Cairo university.",
    ...
    },
    {
      ...
      description: "A replica of the widely known Tumblr social website.",
    ...
    {
      title: "Quizzery",
      description: "A quiz app that you really learn from",
    ...
    },
    {
      ...
      description: "A school project that was implemented in fulfilment of the classword requirements of the computer graphics course",
    ...
    },
    {
      ...
      description: "The aim of this project is to utilize computer vision for the purpose of detecting images involving a flood and localizing the flooded areas within them.",
    ...
    },
    {
      ...
      image: "https://i.imgur.com/aVeHRsB.png",
    ...
    {
      title: "MLPath",
      description: "An MLOPs Library for Tracking & Directory Structure",
